...
<script setup>
    ...
    import Stats from '../../../components/statistics/PlotStatistics/PlotsNewMarker4.vue';
</script>
...
# Alle Ecken bei denen die alte Markierung nicht wieder gefunden wurde, eine neue Markierung gesetzt wurde und eine Neuaufnahme erfolgte  (View)
