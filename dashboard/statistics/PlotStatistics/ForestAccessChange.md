...
<script setup>
    ...
    import Stats from '../../../components/statistics/PlotStatistics/ForestAccessChange.vue';
</script>
...
# Statistik zur geänderten Begehbarkeit gegenüber der Vorgängerinventur (View)
