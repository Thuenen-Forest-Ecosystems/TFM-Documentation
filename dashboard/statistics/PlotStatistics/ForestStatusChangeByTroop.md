...
<script setup>
    ...
    import Stats from '../../../components/statistics/PlotStatistics/ForestStatusChangeByTroop.vue';
</script>
...
# Statistik zu geändertem Waldentscheid gegenüber der Vorgängerinventur nach Anzahl pro Trupp (View)
