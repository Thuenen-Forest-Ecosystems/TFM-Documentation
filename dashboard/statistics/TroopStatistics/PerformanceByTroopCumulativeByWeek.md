...
<script setup>
    ...
    import Stats from '../../../components/statistics/TroopStatistics/PerformanceByTroopCumulativeByWeek.vue';
</script>
...
# Kumulative Leistung pro Inventurtrupp (abgegebene Trakte) pro Woche (View)
