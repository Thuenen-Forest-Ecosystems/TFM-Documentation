...
<script setup>
    ...
    import Stats from '../../../components/statistics/TroopStatistics/PerformanceByTroopByWeekForest.vue';
</script>
...
# Leistung pro Inventurtrupp (abgegebene Trakte) pro Woche (nur Wald, begehbar in 2027) (View)
