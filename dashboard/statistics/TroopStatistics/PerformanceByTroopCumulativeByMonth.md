...
<script setup>
    ...
    import Stats from '../../../components/statistics/TroopStatistics/PerformanceByTroopCumulativeByMonth.vue';
</script>
...
# Kumulative Leistung pro Inventurtrupp (abgegebene Trakte) pro Monat (View)
