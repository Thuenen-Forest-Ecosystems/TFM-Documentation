...
<script setup>
    ...
    import Stats from '../../../components/statistics/TroopStatistics/CountControlledByKT.vue';
</script>
...
# Anzahl abgegebener und kontrollierte Trakte nach Aufnahmetrupp und Kontrolltrupp (View)
