...
<script setup>
    ...
    import Stats from '../../../components/statistics/TroopStatistics/PerformanceByTroopByMonthForest.vue';
</script>
...
# Leistung pro Inventurtrupp (abgegebene Trakte) pro Monat (nur Wald, begehbar in 2027) (View)
