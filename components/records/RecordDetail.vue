...
<template>
    <div>
        <v-list-item
            :title="props.record.record_id ? new Date(props.record.created_at).toLocaleDateString() + ' ' + new Date(props.record.created_at).toLocaleTimeString() : new Date(props.record.updated_at).toLocaleDateString() + ' ' + new Date(props.record.updated_at).toLocaleTimeString()"
